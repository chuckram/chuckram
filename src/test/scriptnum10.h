...
#ifndef CHUCKRAM_TEST_SCRIPTNUM10_H
#define CHUCKRAM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Chuckram Core 0.10.0, for cross-comparison.
 */
public:
