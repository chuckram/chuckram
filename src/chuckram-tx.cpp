...
static void SetupChuckramTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chuckram-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chuckram-tx [options] <hex-tx> [commands]  Update hex-encoded chuckram transaction\n" +
            "or:     chuckram-tx [options] -create [commands]   Create hex-encoded chuckram transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chuckram transaction
