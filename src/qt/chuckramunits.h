...
#ifndef CHUCKRAM_QT_CHUCKRAMUNITS_H
#define CHUCKRAM_QT_CHUCKRAMUNITS_H
...
/** Chuckram unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChuckramUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChuckramUnits(QObject *parent);

    /** Chuckram units.
      @note Source: https://en.chuckram.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CKM,
...
typedef ChuckramUnits::Unit ChuckramUnit;

#endif // CHUCKRAM_QT_CHUCKRAMUNITS_H
