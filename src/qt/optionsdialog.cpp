    ...
    mapper(0)
{
    ...
    ui->chuckramAtStartup->setToolTip(ui->chuckramAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->chuckramAtStartup->setText(ui->chuckramAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openChuckramConfButton->setToolTip(ui->openChuckramConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ChuckramUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->chuckramAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openChuckramConfButton_clicked()
{
