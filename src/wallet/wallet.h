...
#ifndef CHUCKRAM_WALLET_WALLET_H
#define CHUCKRAM_WALLET_WALLET_H
...
public:
     ...
     * on this chuckram node, and set to 0 for transactions that were created
...
#endif // CHUCKRAM_WALLET_WALLET_H
