 ...
 */
#ifndef CHUCKRAM_UTIL_H
#define CHUCKRAM_UTIL_H
...
extern const char * const CHUCKRAM_CONF_FILENAME;
extern const char * const CHUCKRAM_PID_FILENAME;
...
{
    std::string s = strprintf("chuckram-%s", name);
