...
#ifndef CHUCKRAM_INTERFACES_NODE_H
#define CHUCKRAM_INTERFACES_NODE_H
...
//! Top-level interface for a chuckram node (chuckramd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CHUCKRAM_INTERFACES_NODE_H
