...
"""Verify that starting chuckram with -h works as expected."""

from test_framework.test_framework import ChuckramTestFramework
from test_framework.util import assert_equal

class HelpTest(ChuckramTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chuckram with -h for help text")
        ...
        self.log.info("Start chuckram with -version for version information")
        ...
        self.log.info("Start chuckramd with -fakearg to make sure it does not start")
