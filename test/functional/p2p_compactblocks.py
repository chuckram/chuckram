...
# TestP2PConn: A peer we use to send messages to chuckramd, and store responses.
...
class CompactBlocksTest(ChuckramTestFramework):
    ...
    # This test actually causes chuckramd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that chuckramd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for chuckramd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # chuckramd will not send blocktxn responses for blocks whose height is
