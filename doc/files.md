...
* chuckram.conf: contains configuration settings for chuckramd or chuckram-qt
* chuckramd.pid: stores the process id of chuckramd while running
...
* debug.log: contains debug information and general logging generated by chuckramd or chuckram-qt
