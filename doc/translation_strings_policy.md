...
This document provides guidelines for internationalization of the Chuckram Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chuckram_en.ts` remains unchanged.
