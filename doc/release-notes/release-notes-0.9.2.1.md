Chuckram Core version 0.9.2.1 is now available from:

  https://chuckram.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CKM to 0.01 CKM
...
- Fix "Start chuckram on system login"
