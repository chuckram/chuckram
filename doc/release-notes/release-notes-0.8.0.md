Chuckram-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/chuckram/files/Chuckram/chuckram-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Chuckram
...
New/changed settings (command-line or chuckram.conf file)
--------------------------------------------------------
