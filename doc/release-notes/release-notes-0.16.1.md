Chuckram Core version 0.16.1 is now available from:

  <https://chuckramcore.org/bin/chuckram-core-0.16.1/>
...
- #12843 `df38b13` Test starting chuckramd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure chuckramd processes are cleaned up when tests end (sdaftuar)
