Chuckram Core version 0.9.4 is now available from:

  https://chuckram.org/bin/0.9.4/
...
this update is incompatible with the Chuckram system and could lead to consensus
forks.

Chuckram Core released binaries from https://chuckram.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~chuckram/+archive/ubuntu/chuckram
- A third-party or self-compiled Chuckram Core

upgrade to Chuckram Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
