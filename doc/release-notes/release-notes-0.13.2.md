Chuckram Core version 0.13.2 is now available from:

  <https://chuckram.org/bin/chuckram-core-0.13.2/>
...
- #8908 `4a974b2` Update chuckram-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow chuckram-tx to create v2 transactions (btcdrak)
